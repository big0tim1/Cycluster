...
def myboxplot(data, x=1, axh=None, width=0.8, boxcolor='black', scatterwidth=0.6, dotcolor='red', returnx=False,
              subsetInd=None, altDotcolor='gray', violin=False, **kwargs):
...
def manyboxplots(df, cols=None, axh=None, colLabels=None, annotation='N', horizontal=False, vRange=None, xRot=0,
                 **kwargs):
...
def swarmbox(x, y, data, hue=None, palette=None, order=None, hue_order=None, connect=False, connect_on=[], legend_loc=0,
             legend_bbox=None, swarm_alpha=1, swarm_size=5, box_alpha=1, box_edgecolor='k', box_facewhite=False):
    ...
    if not hue is None and not legend_loc is None:
        plt.legend([plt.Circle(1, color=c, alpha=1) for c in palette], hue_order, title=hue, loc=legend_loc,
