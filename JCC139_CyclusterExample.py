...
inf1 = "NIC FPID Cytokines JC.csv"
inf2 = "NICU_PED_Nurses_JC.csv"
...
pprint.pprint(longDf.loc[:, 'ptid'])
"""Print table of sample count"""
pprint.pprint(longDf.loc[longDf.cytokine=='mcp1'].groupby(['genotype', 'dpi'])['ptid'].count())
